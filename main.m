...
addpath('C:\Users\Christos\Desktop\project_sound\input');
...
if (select == 1)
   ...
   audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputSeries.wav',...
                            y, fs, 'BitsPerSample', 32);
   pause(Time); % Allow time for the previous sound() to finish
   ...
   sound(y,fs); % Play signal after Reverb
    ...
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputFlanger.wav',...
                                        y1, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputCompressor.wav',...
                                        y2, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputReverb.wav',...
                                        y3, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputTremolo.wav',...
                                        y5, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputOverdrive.wav',...
                                        y6, fs, 'BitsPerSample', 32);    
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputPanning.wav',...
                                        y7, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputGuitarDistortion.wav',...
                                        y8, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputEcho.wav',...
                                        y9, fs, 'BitsPerSample', 32);                                  
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputFuzz.wav',...
                                        y11, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputChorus.wav',...
                                        y12, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputVibrato.wav',...
                                        y13, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputWahWah.wav',...
                                        y14, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputConvReverb.wav',...
                                        y15, fs, 'BitsPerSample', 32);
    audiowrite('C:\Users\Christos\Desktop\project_sound\output\outputExpansion.wav',...
                                        y16, fs, 'BitsPerSample', 32);
